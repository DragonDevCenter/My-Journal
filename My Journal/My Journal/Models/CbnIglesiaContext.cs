...
public partial class CbnIglesiaContext : DbContext
{
    ...
    public virtual DbSet<OfrendasCategorium> OfrendasCategoria { get; set; }

    public virtual DbSet<OfrendasDetalle> OfrendasDetalles { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OfrendasCategorium>(entity =>
        {
        ...
        modelBuilder.Entity<OfrendasDetalle>(entity =>
        {
            entity.HasKey(e => e.IdDetalle).HasName("PK__Ofrendas__E43646A5363CFAEB");

            entity.ToTable("OfrendasDetalle", "IGLESIA");

            entity.Property(e => e.FechaCreacion).HasColumnType("datetime");
            entity.Property(e => e.FechaModifica).HasColumnType("datetime");

            entity.HasOne(d => d.DivisaNavigation).WithMany(p => p.OfrendasDetalles)
                .HasForeignKey(d => d.Divisa)
                .HasConstraintName("FK__OfrendasD__Divis__5DCAEF64");

            entity.HasOne(d => d.IdCatOfrendaNavigation).WithMany(p => p.OfrendasDetalles)
                .HasForeignKey(d => d.IdCatOfrenda)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__OfrendasD__IdCat__5CD6CB2B");

            entity.HasOne(d => d.IdOfrendaNavigation).WithMany(p => p.OfrendasDetalles)
                .HasForeignKey(d => d.IdOfrenda)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__OfrendasD__IdOfr__5BE2A6F2");

            entity.HasOne(d => d.UsuarioCreacionNavigation).WithMany(p => p.OfrendasDetalles)
                .HasForeignKey(d => d.UsuarioCreacion)
                .HasConstraintName("FK__OfrendasD__Usuar__5EBF139D");
        });
        ...
        modelBuilder.Entity<Usuario>(entity =>
        {
            ...
            entity.Property(e => e.Aprllidos).HasMaxLength(50);
